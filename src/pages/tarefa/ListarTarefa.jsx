...
const initialRows = [
  createData(1, 'Colecionador', 'Descrição ', '2022-01-01', '2022-01-02', 'Concluída', 'Recurso 1'),
  createData(2, 'Ambientalista', 'Descrição', '2022-01-03', '2022-01-04', 'Em Andamento', 'Recurso 2'),
  createData(3, 'Paladino', 'Descrição ', '2022-01-04', '2022-01-05', 'Em Andamento', 'Recurso 3'),
  createData(4, 'Elfo', 'Descrição', '2022-01-05', '2022-01-06', 'Em Andamento', 'Recurso 4'),
  createData(5, 'Bardo', 'Descrição ', '2022-01-06', '2022-01-07', 'Em Andamento', 'Recurso 5'),
  createData(6, 'Anão', 'Descrição ', '2022-01-07', '2022-01-08', 'Aguardando', 'Recurso 6'),
];
...
const ListarTarefa = () => {
  ...
  return (
    <>
      <Card>
        <CardHeader
          title="Classes Criadas"
          subheader="Listagem das Classes"
        />
        <CardContent>
